		...
		draw : function(){
			...
			if (this.display){
				...
				each(this.xLabels,function(label,index){
					...
					// Tweak: changing the x labels
					if (app.data.points.length > 24) {
						if (label == '0:00') {
							label = app.constants.months[app.data.points[index].date.getMonth()] + ' ' + app.data.points[index].date.getDate();
						} else {
							label = '';
						}
					}
